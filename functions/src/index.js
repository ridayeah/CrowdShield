...
exports.createUserProfile = exports.health = void 0;
var functions = require("firebase-functions");
var firebaseAdmin_1 = require("./config/firebaseAdmin");
// Health check
...
exports.createUserProfile = functions.auth.user().onCreate(function (user) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, (0, firebaseAdmin_1.db)().collection("users").doc(user.uid).set({
                    role: "attendee",
